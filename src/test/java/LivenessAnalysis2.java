...
import java.util.Comparator;
    ...
    public class LivenessAnalysis2 {
        private IRRoot ir;
        public LivenessAnalysis2(IRRoot ir) {
            this.ir = ir;
        }
                        ...
                        if (color[i]==true){
                            switch (i){
                                ...
                                case 3:
                                    ...
                                    break;
                                case 4:
                                    register.setNewName("R5");
                                case 5:
                                    register.setNewName("R6");
                                case 6:
                                    register.setNewName("R7");
                        /*case 4:
